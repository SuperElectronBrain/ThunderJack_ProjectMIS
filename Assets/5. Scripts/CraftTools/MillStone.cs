	...
	void Update()
	{
		...
		if (bProgress == true)
		{
			if (m_Input != 0)
			{
				...
				float t_X = Vector3.Dot(m_PreviousHandlePosition, t_CurrentHandlePosition);//�������� m_PreviousHandlePosition�� ������ �ϴ� t_CurrentHandlePosition�� x�� ������ �����
				float t_Y = Vector3.Dot((t_CurrentHandlePosition - (m_PreviousHandlePosition * t_X)).normalized, t_CurrentHandlePosition);//t_CurrentHandlePosition���� x�� ������ �����ϰ� y�� ������ ����
