Shader "Universal Render Pipeline/Spine/AlphaSkeleton Lit" {
	Properties {
	...
	SubShader {
		...
		Tags { "RenderPipeline" = "UniversalPipeline" "Queue" = "AlphaTest" "IgnoreProjector"="True" "RenderType"="Transparent" }
		LOD 100
		Cull Off
		ZWrite[_ZWrite]
